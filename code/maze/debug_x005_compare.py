...
deltas = {}
for n in pre_params:
    deltas[n] = post_params[n] - pre_params[n]
...
print("(Apply all deltas except named param; if puzzle_acc recovers, that param caused drop)")
...
print("(Apply only named param's delta; if puzzle_acc drops, that param alone causes drop)")
