...
Fixed init & 98.7\% & 96.8$\pm$0.8\% & 1$\times$ & 96.8 \\  % x182j.log, x182k.log, x182l.log
\bottomrule
\end{tabular}
...
all other methods. Fresh init is slightly better (96.9\% vs 96.8\%) with lower
variance ($\pm$0.6\% vs $\pm$0.8\%).
