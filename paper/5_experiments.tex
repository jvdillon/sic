...
dihedral augmentation and digit permutation) and a randomly sampled 38,400
puzzle subset of 422,786 test puzzles. All puzzles have exactly 17 given digits
(the minimum for a unique solution).
...
their ${\sim}$80\%; the best seed reached 87\%, though such results are rare due to variance).
