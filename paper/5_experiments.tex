...
maintaining low-level diversity. (The x182 main results use copy/all; the 0.1pp
difference from x179q reflects seed variance.)
...
$q_\text{halt}$ stays negative (uncertain) throughout, and fewer than 5\% halt
