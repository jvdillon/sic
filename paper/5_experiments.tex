...
TTA-8 (test-time aug.) & n/a & 97.3\% & 8$\times$ \\  % x00.log with TTA
Halt-first (12 ch.) & n/a & 97.2\% & 1.5$\times$$^\dagger$ \\  % x02.log + x03.log + x04.log halt-first
\midrule
...
Cell accuracy is n/a for ensemble methods (not tracked per-puzzle).
