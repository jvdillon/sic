...
\usepackage[letterpaper,textwidth=6.75in,textheight=9.0in,left=0.875in,top=0.75in,columnsep=0.25in,headheight=10pt,headsep=10pt,footskip=25pt]{geometry}
\usepackage{times}
\usepackage{natbib}
\input{preamble}
...
% Title with horizontal rules, author below.
\def\@maketitle{%
  \hrule height1pt \vskip .35in
  \begin{center}%
    {\Large\bfseries \@title \par}%
  \end{center}%
  \vskip .1in \hrule height1pt \vskip .25in
  \begin{center}%
