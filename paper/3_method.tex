...
\end{equation}
%
where $J_L, J_H$ are the Jacobians of the L and H updates, and $J_{HL}, J_{LH}$
capture cross-dependencies. The inner equilibrium's conditioning $(I - J_L)^{-1}$
gets embedded inside the outer inverse---the mathematical signature of bilevel
structure. Good conditioning of the inner loop propagates to the full system.
