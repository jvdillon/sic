...
(updated once per H-cycle). The $\operatorname{stop}(\cdot)$ operator detaches
its argument from the computation graph, preventing gradient flow between
H-cycles and enabling stable training.

On Sudoku-Extreme (10,000 puzzles with 17 given digits), a 7M parameter TRM
achieves ${\sim}$86\% puzzle accuracy---substantially outperforming larger language
