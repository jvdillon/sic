...
As in nature, this work was also resource constrained: all experimentation used a single RTX 5090. Necessitatity compelled our invention of a modified SwiGLU~\citep{shazeer2020swiglu} which made Muon~\citep{jordan2024muon} viable. With these improvements and $K{=}1$ training, we match TRM baseline performance ($\sim$87\%) in just 48 min (8k steps, bs${=}$384, ${\sim}$16GiB). Higher accuracy ($\sim$97\%) is achieved in 36k steps and $K{=}4$ (bs${=}$192, ${\sim}$30GiB) and takes about 6 hours.
