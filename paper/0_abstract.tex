...
As in nature, this work was also resource constrained: all experimentation used a single RTX 5090. Necessity compelled our invention of a modified SwiGLU~\citep{shazeer2020swiglu} which made Muon~\citep{jordan2024muon} viable. With these improvements and $K{=}1$ training, we match TRM baseline performance (${\sim}$85.5\%) in just 48 min (8k steps, batch size 384, ${\sim}$16GiB). Higher accuracy (${\sim}$96.9\%) is achieved in 36k steps and $K{=}4$ (batch size 192, ${\sim}$30GiB) and takes about 6 hours.
