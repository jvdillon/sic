...
As in nature, this work was also resource constrained: all experimentation used a single RTX 5090. Necessity compelled our invention of a modified SwiGLU [Shazeer, 2020] which made Muon [Jordan et al., 2024] viable. With these improvements and K=1 training, we match TRM baseline performance (∼86%) in just 48 min (8k steps, bs=384, ∼16GiB). Higher accuracy (∼97%) is achieved in 36k steps and K=4 (bs=192, ∼30GiB) and takes about 6 hours.
